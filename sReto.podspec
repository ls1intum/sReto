#
#  Be sure to run `pod spec lint sReto.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of sReto in Markdown format.
  ...
  s.homepage     = "http://www1.in.tum.de"
  ...
  s.source       = { :git => "https://github.com/ls1intum/sReto.git", :commit => "e034e29f83a61eb7244a3d215b4c58f98f927dfc" }
